    ...
    <form className=''>
      <div className="space-y-12">
        <div className="border-b border-gray-200 pb-12">
          <h2 className="text-base/7 font-semibold">Product Information</h2>
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <div className="flex items-center rounded-md bg-white/5 pl-3 outline outline-1 -outline-offset-1 outline-white/10 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                  <div className="shrink-0 select-none text-base text-gray-400 sm:text-sm/6">ecommerce.com/</div>
                  <input
                    id="username"
                    name="username"
                    type="text"
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                ...
                <button
                  type="button"
                  className="rounded-md bg-white/10 px-3 py-2 text-sm font-semibold text-gray-500 ring-1 ring-inset ring-white/5 hover:bg-white/20"
                >
                  Change
                </button>
              </div>
              ...
              <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-200/25 px-6 py-10">
                <div className="text-center">
                  ...
                  <div className="mt-4 flex text-sm/6 text-gray-500">
                    <label
                      htmlFor="file-upload"
                      className="relative cursor-pointer rounded-md bg-transparent font-semibold text-indigo-400 focus-within:outline focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-indigo-500 hover:text-indigo-300"
                    >

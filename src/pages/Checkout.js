...
function Checkout() {
  ...
  function handleOrder() {
    if (!selectedAddress || !paymentMethod) {
      window.alert('Please select an address and payment method');
      return;
    }
    ...
    const order = {
      ...
      paymentMethod,
      status: 'pending', // Other status can be delivered, cancelled, returned, etc.q
    };
  ...
  return (
    <>
      {cartItems.length === 0 && <Navigate to="/" replace />}
      {currentOrder && (
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300
                           ...
                           focus:ring-indigo-600 sm:text-sm sm:leading-6 ps-2"
                          {...register('name', {
                    ...
                    <div className="sm:col-span-3">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          id="phone-number"
                          className="block w-full rounded-md border-0 py-1.5 
                          text-gray-900 shadow-sm ring-1 ps-2 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            ...
            <div className="mx-auto mt-12 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
              <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                ...
                <div className="flow-root">
                  <ul
                    role="list"
                    className="-my-6 divide-y divide-gray-200 max-h-96 overflow-y-auto scrollbar-hide"
                  >
